...
var utils = {
    ...
    keyVCodeProcessor: function (self, params, deferred) {
        ...
        if (utils.isKeyHash(eveApiKey)) {
            ...
            return deferred.reject(new error.EveInvalidRequestError({ message: "Requires an object with a keyID and vCode property." }));
        }
    },
    keyVCodeCharIDProcessor: function (self, params, deferred) {
        ...
        return deferred.reject(new error.EveInvalidRequestError({ message: "Requires a keyID, vCode and characterID property." }));
    },
