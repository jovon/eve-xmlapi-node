...
EveClient.cache.RedisCache = require('./cache/redis')
...
EveClient.EveResource = require('./EveResource')
  ...
  setCache: function(cacheType, options) {
    switch (cacheType.toLowerCase()) {
      case 'file':
        ...
        break;
      case 'redis':
        this._cache = new EveClient.cache.RedisCache(options)
        break;
      default:
